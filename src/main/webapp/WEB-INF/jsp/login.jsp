...
COVID19_PATIENT_MONITORING
</span>

<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
<input class="input100" type="email" id="username" name="username" maxlength="70" placeholder="Email">
...
<input class="input100" type="password" id="pwd" name="password" maxlength="15" placeholder="Password"><span class="focus-input100"></span>
<span class="symbol-input100">
...
<a class="txt2" href="${pageContext.request.contextPath}/forgotpassword">
Username / Password?
</a>
</div>
